...
struct Usage usage_table[] = {
    ...
    /* \uscheme\ [[usage_table]] entries added in exercises S354e */
    { ANEXP(BREAKX),     "(break)" },
...
/* arrays of shift functions added to \uscheme\ in exercises S353d */
...
/* arrays of shift functions added to \uscheme\ in exercises S354a */
...
/* placeholder */
/* lowering functions for {\uschemeplus} S354f */
...
/* rows of \uscheme's [[exptable]] that are sugared in {\uschemeplus} ((uschemeplus)) S354b */
  ...
  /* rows added to \uscheme's [[exptable]] in exercises S353e */
...
/* cases for [[reduce_to_exp]] that are sugared in {\uschemeplus} ((uschemeplus)) S354d */
  ...
  /* cases for \uscheme's [[reduce_to_exp]] added in exercises S354c */
...
XDef reduce_to_xdef(int code, struct Component *out) {
    ...
    /* [[reduce_to_xdef]] case for [[ADEF(DEFINE)]] ((uschemeplus)) S354g */
    case ADEF(DEFINE):
