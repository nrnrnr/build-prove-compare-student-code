...
and (* In the operational semantics, \nml and micro-Scheme *)
    (* have the same values, and their representations are *)
    (* similar enough that I can reuse the projection, *)
    (* embedding, and printing functions from Chapter [->]. *)
...
(* The [[BEGIN]] form is intended for use with primitive *)
(* functions [[println]] and [[print]].         *)
(*                                              *)
(* \qvspace-2                                   *)
(*                                              *)
(* \qbreak Except for [[VALREC]], definitions are as in *)
(* micro-Scheme. \nmllabeldef                   *)
...
(* On a gross level, the evaluator for \nml is  *)
(* structured in the same way as the evaluator for *)
(* micro-Scheme. Both evaluators include the usual *)
(* definitions of [[eval]], [[evaldef]], [[basis]], and *)
(* [[processDef]]. Language-specific testing code *)
(* appears in this appendix (\crefmla.testing), and *)
(* other code is shared.                        *)
...
val predefs = 
               ...
               , ";                                               "
               , ";  Binding a pair into an association list works just as "
               , ";  in untyped micro-Scheme. [*]                 "
               , ";  <predefined {\\nml} functions>=               "
...
(*                                              *)
(* Given primitives and user code, the interpreter *)
(* computes the type environment and the value  *)
(* environment simultaneously. [*] \makenowebnotdef *)
(* (from \LApredefined \nml functions \upshape[->]\RA) *)
(* <boxed values 122>=                          *)
