...
(* <definition of [[validate]], for the types of the value constructors of [[T]]>= *)
      ...
      val _ = op validateLengths       : tyvar list * kind list -> unit
        in  (* \qbreak When uML is extended to include value *)
            (* constructors that have existential types, additional *)
...
(* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ *)
      ...
      fun choicetype ((p, e), Gamma) =
            let val (Gamma', tau, c) = pattype (p, Gamma)
                ...
                val _ =
                       (* Skolem types that are introduced by a pattern match *)
                        (* may not appear in the argument type or the result *)

                      (* type of that pattern match, as shown by this rule: \ *)
                      ...
                      (* {indented} The free skolem types of \subsnGamma' are *)
                        (* found by looking at all the types bound in \subsn *)

                      (* Gamma'. But the free skolem types of \subsnGamma are *)
                        (* easier to find; it's enough to look at what \subsn *)
...
(* <check [[p]], [[e]], [[Gamma']], [[Gamma]], [[ty]], and [[con]] for escaping skolem types ((existentials))>= *)
               ...
               (* <definitions of skolem functions [[fail]] and [[badType]]>= *)
                        ...
                        in  case (inter (patSkolems, tySkolems), inter (
                              ...
                              of (mu :: _,  _) =>
                     (* When tau-->tau' has an escaping skolem type, an error *)

                       (* message is issued for tau' if possible. If not, one *)
