 ...
 * 
 * As promised in \crefpage(impcore.error-helpers, this
 * appendix implements auxiliary functions that help
 * detect common errors. Function [[checkargc]] checks
 * to see if the number of actual arguments passed to a
 * function is the number that the function expected. \
 * implabelcheckargc
 * <error.c>=
 */
 ...
 * but a good C compiler will identify and optimize a
